		...
		<div class="container">
			...
			<div class="row row-pb-md">
				<div class="col-md-4">
					<div class="blog-entry">
						<div class="blog-img">
							<a href="blog.jsp"><img src="${path}/images/blog-4.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
						</div>
						<div class="desc">
							<p class="meta">
				...
				<div class="col-md-4">
					<div class="blog-entry">
						<div class="blog-img">
							<a href="blog.jsp"><img src="${path}/images/blog-5.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
						</div>
						<div class="desc">
							<p class="meta">
								<span class="cat"><a href="#">Events</a></span>
				...
				<div class="col-md-4">
					<div class="blog-entry">
						<div class="blog-img">
							<a href="blog.jsp"><img src="${path}/images/blog-6.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
						</div>
						<div class="desc">
							<p class="meta">
								<span class="cat"><a href="#">Events</a></span>
			...
			<div class="row row-pb-md">
				<div class="col-md-4">
					<div class="blog-entry">
						<div class="blog-img">
							<a href="blog.jsp"><img src="${path}/images/blog-12.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
						</div>
						<div class="desc">
							<p class="meta">
								<span class="cat"><a href="#">Events</a></span>
				...
				<div class="col-md-8">
					<div class="blog-entry">
						<div class="blog-img">
							<a href="blog.jsp"><img src="${path}/images/blog-13.jpg" class="img-responsive" alt="html5 bootstrap template"></a>
						</div>
						<div class="desc">
								<p class="meta">
								<span class="cat"><a href="#">Events</a></span>
